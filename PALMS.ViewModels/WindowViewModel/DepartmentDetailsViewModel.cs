...
namespace PALMS.ViewModels
{
    public class DepartmentDetailsViewModel : ViewModelBase, IWindowDialogViewModel
    {
        ...
        public ObservableCollection<DepartmentContractViewModel> SortedContracts => SortContracts();
        ...
        private ObservableCollection<DepartmentContractViewModel> SortContracts()
        {
            if (Departments == null || Departments.Count == 0) return null;

            var depContracts = DepartmentContracts?.Where(x =>
                    (x.DepartmentViewModel == null && x.DepartmentId == SelectedDepartment?.Id) ||
        ...
        private void AddDepartment()
        {
            Departments.Add(new DepartmentViewModel
            {
                ...
                Express = SelectedClient.ClientInfo.Express,
        ...
        public void AddSubDepartment()
        {
            Departments.Add(new DepartmentViewModel {
                ClientId = SelectedClient.Id,
                Express = SelectedDepartment.Express,
