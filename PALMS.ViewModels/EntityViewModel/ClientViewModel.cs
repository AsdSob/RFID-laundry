...
namespace PALMS.ViewModels.EntityViewModel
{
    ...
    public class ClientViewModel : ViewModelBase, IDataErrorInfo
    {
        ...
        {
            get => _invoiceName;
            set => Set(ref _invoiceName, value);
        }
        ...
        public Func<ClientViewModel, string, bool> OrderUniqueValidationFunc { get; set; }
        ...
        private string Validate(string columnName)
        {
            ...
            else if (columnName == nameof(OrderNumber))
            {
                if (!ShortName.ValidateRequired(out error))
                {
                    return error;
                ...
                if (NameUniqueValidationFunc != null && !NameUniqueValidationFunc(this, nameof(OrderNumber)))
                {
                    return "OrderNumber is already exist";
                }
            }
        ...
        private void Update(Client client)
        {
            ...
            InvoiceName = OriginalObject.InvoiceName;
        ...
        public void AcceptChanges()
        {
            ...
            OriginalObject.InvoiceName = InvoiceName;
