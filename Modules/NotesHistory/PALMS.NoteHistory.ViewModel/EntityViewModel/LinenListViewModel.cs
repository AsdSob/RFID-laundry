...
{
    public class LinenListViewModel : ViewModelBase, IDataErrorInfo
    {
        private int _id;
        ...
        public LinenList OriginalObject { get; set; }
        ...
        public Func<LinenListViewModel, string, bool> NameUniqueValidationFunc { get; set; }

        public string this[string columnName] => Validate(columnName);

        public LinenListViewModel()
        {
            OriginalObject = new LinenList();
        }

        public LinenListViewModel(LinenList entity)
        {
