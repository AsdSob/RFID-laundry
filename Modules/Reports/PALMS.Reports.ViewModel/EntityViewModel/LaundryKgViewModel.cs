...
{
    public class LaundryKgViewModel : ViewModelBase, IDataErrorInfo
    {
        private LaundryKg _originalObject;
        private int _id;
        ...
        public LaundryKg OriginalObject
        {
            get => _originalObject;
            set => Set(ref _originalObject, value);
        }

        public LaundryKgViewModel()
        {
            OriginalObject = new LaundryKg();
        }

        public LaundryKgViewModel(LaundryKg entity)
        {
        ...
        private void Update(LaundryKg originalObject)
        {
