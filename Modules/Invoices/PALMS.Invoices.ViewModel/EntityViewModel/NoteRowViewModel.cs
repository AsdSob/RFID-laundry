...
namespace PALMS.Invoices.ViewModel.EntityViewModel
{
    public class NoteRowViewModel : ViewModelBase, IDataErrorInfo
    {
        ...
        private double _primeCollectionQty;
        ...
        private LinenList _linenList;

        public string LinenName { get; set; }

        public LinenList LinenList
        {
            get => _linenList;
        ...
        public double PrimeCollectionQty
        {
            get => _primeCollectionQty;
            set => Set(ref _primeCollectionQty, value);
        }
        ...
        private void Update(NoteRow noteRow)
        {
            ...
            PrimeCollectionQty = OriginalObject.PrimeCollectionQty;
        ...
        public void AcceptChanges()
        {
            ...
            OriginalObject.PrimeCollectionQty = PrimeCollectionQty;
