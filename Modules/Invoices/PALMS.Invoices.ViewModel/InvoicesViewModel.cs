...
{
    public class InvoicesViewModel : ViewModelBase, IInitializationAsync
    {
        ...
        public InvoicesViewModel(TabsViewModel content, ICanExecuteMediator canExecuteMediator)
        {
